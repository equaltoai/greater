import { w as attributes, G as stringify, y as attr_class, z as attr, K as attr_style, x as clsx, v as head, J as ensure_array_like, F as bind_props } from "./index2.js";
...
function Avatar($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function AvatarContent($$renderer3) {
      if (loading) {
        $$renderer3.push("<!--[-->");
        $$renderer3.push(`<div class="gr-avatar__loading" aria-hidden="true"><svg class="gr-avatar__spinner" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12a9 9 0 11-6.219-8.56"></path></svg></div>`);
      } else {
        $$renderer3.push("<!--[!-->");
        if (src && true) {
          $$renderer3.push("<!--[-->");
          $$renderer3.push(`<img class="gr-avatar__image"${attr("src", src)}${attr("alt", alt || name || "Avatar")}${attr_style(`display: ${stringify("none")}`)} onload="this.__e=event" onerror="this.__e=event"/> `);
          {
            ...
            if (initials) {
              $$renderer3.push("<!--[-->");
              $$renderer3.push(`<span class="gr-avatar__initials"${attr_style(`background-color: ${stringify(initialsBackgroundColor())}`)}>${escape_html(initials)}</span>`);
            } else {
              $$renderer3.push("<!--[!-->");
              if (fallback) {
                $$renderer3.push("<!--[-->");
                ...
                $$renderer3.push("<!--[!-->");
                $$renderer3.push(`<svg class="gr-avatar__fallback-icon" width="100%" height="100%" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"></path></svg>`);
              }
              $$renderer3.push(`<!--]-->`);
            }
            $$renderer3.push(`<!--]--></div>`);
          ...
          if (initials) {
            $$renderer3.push("<!--[-->");
            $$renderer3.push(`<span class="gr-avatar__initials"${attr_style(`background-color: ${stringify(initialsBackgroundColor())}; color: white;`)}>${escape_html(initials)}</span>`);
          } else {
            $$renderer3.push("<!--[!-->");
            if (fallback) {
              $$renderer3.push("<!--[-->");
      ...
      if (status) {
        $$renderer3.push("<!--[-->");
        $$renderer3.push(`<div${attr_class(clsx(statusClass()))}${attr("id", statusId)} role="status"${attr("aria-label", `Status: ${status}`)}></div>`);
      } else {
        $$renderer3.push("<!--[!-->");
      }
      $$renderer3.push(`<!--]-->`);
...
function Skeleton($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function SkeletonContent($$renderer3) {
      if (animation === "wave") {
        $$renderer3.push("<!--[-->");
        $$renderer3.push(`<div class="gr-skeleton__wave"></div>`);
      } else {
        $$renderer3.push("<!--[!-->");
      }
      $$renderer3.push(`<!--]-->`);
...
function BaseLayout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    head("1q4t6f0", $$renderer2, ($$renderer3) => {
      $$renderer3.push(`<meta name="description"${attr("content", description)}/> <meta property="og:title"${attr("content", title)}/> <meta property="og:description"${attr("content", description)}/>`);
    });
...
function Navigation($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<nav class="nav svelte-jxkij"><div class="user-section svelte-jxkij">`);
    if (authStore.isAuthenticated && authStore.currentUser) {
      ...
      $$renderer2.push(`<!--]--> <div class="user-info svelte-jxkij"><div class="user-name svelte-jxkij">${escape_html(authStore.currentUser.display_name || authStore.currentUser.username)}</div> <div class="user-handle svelte-jxkij">@${escape_html(authStore.currentUser.acct)}</div></div></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    ...
    $$renderer2.push(`<!--]--></div> <ul class="nav-list svelte-jxkij"><!--[-->`);
    const each_array = ensure_array_like(navItems);
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      let item = each_array[$$index];
      $$renderer2.push(`<li><a${attr("href", item.href)}${attr_class(`nav-link ${stringify(isActive(item.href, item.exact) ? "active" : "")}`, "svelte-jxkij")}${attr("aria-current", isActive(item.href, item.exact) ? "page" : void 0)}>`);
      if (isActive(item.href, item.exact)) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<span class="active-indicator svelte-jxkij"></span>`);
      } else {
        $$renderer2.push("<!--[!-->");
      }
      ...
      $$renderer2.push(`<!--]--></span> <span class="nav-label svelte-jxkij">${escape_html(item.label)}</span></a></li>`);
    }
    $$renderer2.push(`<!--]--></ul> `);
    if (authStore.isAuthenticated) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="compose-button-wrapper svelte-jxkij"><a href="/compose" class="compose-button svelte-jxkij"><span class="compose-icon svelte-jxkij">✏️</span> <span>Compose</span></a></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--></nav> <nav class="mobile-nav svelte-jxkij"><a href="/home"${attr_class(`mobile-nav-link ${stringify(isActive("/home", true) ? "active" : "")}`, "svelte-jxkij")}>`);
    if (isActive("/home", true)) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<span class="mobile-indicator svelte-jxkij"></span>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> <span>🏠</span></a> <a href="/local"${attr_class(`mobile-nav-link ${stringify(isActive("/local") ? "active" : "")}`, "svelte-jxkij")}>`);
    if (isActive("/local")) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<span class="mobile-indicator svelte-jxkij"></span>`);
    } else {
    ...
    $$renderer2.push(`<!----></a> <a href="/notifications"${attr_class(`mobile-nav-link ${stringify(isActive("/notifications") ? "active" : "")}`, "svelte-jxkij")}>`);
    ...
    $$renderer2.push(`<!--]--></span></a> <a href="/compose" class="mobile-compose-button svelte-jxkij"><span>✏️</span></a> <a href="/settings"${attr_class(`mobile-nav-link ${stringify(isActive("/settings") ? "active" : "")}`, "svelte-jxkij")}>`);
    ...
    $$renderer2.push(`<!--]--> <span>⚙️</span></a></nav>`);
  });
}
function MainLayout($$renderer, $$props) {
  ...
  BaseLayout($$renderer, {
    title,
    children: ($$renderer2) => {
      $$renderer2.push(`<div class="main-layout svelte-1vud52s"><aside class="sidebar svelte-1vud52s">`);
      Navigation($$renderer2);
      $$renderer2.push(`<!----></aside> <main class="content svelte-1vud52s">`);
      children($$renderer2);
...
function TimelineTabs($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      ...
      $$renderer2.push(`<button role="tab"${attr("aria-selected", active === tab.id)}${attr_class("svelte-16064hu", void 0, { "active": active === tab.id })}>${escape_html(tab.label)}</button>`);
    }
    $$renderer2.push(`<!--]--></div>`);
  });
}
    ...
    if (sensitive && !showSensitive) {
      ...
      for (let index = 0, $$length = each_array.length; index < $$length; index++) {
        ...
        if (category === "IMAGE" || category === "GIFV" || category === "VIDEO") {
          ...
          if (category === "VIDEO") {
            $$renderer2.push("<!--[-->");
            $$renderer2.push(`<video${attr("src", attachment.url)}${attr("poster", attachment.preview_url)} class="h-full w-full object-cover" muted playsinline controls></video> <div class="pointer-events-none absolute inset-0 flex items-center justify-center"><div class="rounded-full bg-black/60 p-3"><svg class="h-8 w-8 text-white" fill="currentColor" viewBox="0 0 20 20"><path d="M6.3 2.841A1.5 1.5 0 004 4.11V15.89a1.5 1.5 0 002.3 1.269l9.344-5.89a1.5 1.5 0 000-2.538L6.3 2.84z"></path></svg></div></div>`);
          } else {
            $$renderer2.push("<!--[!-->");
            if (category === "GIFV") {
              $$renderer2.push("<!--[-->");
              $$renderer2.push(`<video${attr("src", attachment.url)}${attr("poster", attachment.preview_url)} class="h-full w-full object-cover" muted loop autoplay playsinline></video>`);
            } else {
              $$renderer2.push("<!--[!-->");
              ...
              if (!imageLoadStates[attachment.id]) {
                $$renderer2.push("<!--[-->");
                $$renderer2.push(`<div class="absolute inset-0 animate-pulse bg-gray-200 dark:bg-gray-700"></div>`);
              } else {
                $$renderer2.push("<!--[!-->");
              }
              $$renderer2.push(`<!--]-->`);
          ...
          if (attachment.spoiler_text) {
            $$renderer2.push("<!--[-->");
            $$renderer2.push(`<div class="absolute left-2 top-2 rounded-full bg-black/60 px-2 py-1 text-[11px] font-medium uppercase tracking-wide text-white">CW</div>`);
          } else {
            $$renderer2.push("<!--[!-->");
          }
          $$renderer2.push(`<!--]--> <div class="absolute right-2 top-2 rounded-full bg-black/50 px-2 py-1 text-[11px] uppercase tracking-wide text-white">${escape_html(category)}</div> `);
          if (attachment.description) {
            $$renderer2.push("<!--[-->");
            $$renderer2.push(`<div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-2"><span class="text-xs text-white">ALT</span></div>`);
          } else {
            $$renderer2.push("<!--[!-->");
          }
          $$renderer2.push(`<!--]--></button>`);
          ...
          if (category === "AUDIO") {
            $$renderer2.push("<!--[-->");
            $$renderer2.push(`<div class="flex items-center space-x-3 rounded-lg bg-gray-100 p-4 dark:bg-gray-800"><svg class="h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3"></path></svg> <div class="flex-1"><audio${attr("src", attachment.url)} controls class="w-full" preload="metadata"></audio></div></div>`);
          } else {
            $$renderer2.push("<!--[!-->");
            if (category === "DOCUMENT") {
              $$renderer2.push("<!--[-->");
              $$renderer2.push(`<div class="flex h-32 items-center justify-center rounded-lg bg-gray-100 p-4 text-sm text-gray-600 dark:bg-gray-800 dark:text-gray-300"><svg class="mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9l-6-6H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg> Document attachment</div>`);
            } else {
              $$renderer2.push("<!--[!-->");
              $$renderer2.push(`<div class="flex h-32 items-center justify-center rounded-lg bg-gray-100 p-4 text-sm text-gray-600 dark:bg-gray-800 dark:text-gray-300">Unsupported media</div>`);
            }
            $$renderer2.push(`<!--]-->`);
          }
          $$renderer2.push(`<!--]-->`);
...
function StatusSkeleton($$renderer) {
  $$renderer.push(`<div class="card p-4 space-y-3"><div class="flex items-start gap-3">`);
  Skeleton($$renderer, { variant: "circular", width: "48px", height: "48px" });
  $$renderer.push(`<!----> <div class="flex-1 space-y-3"><div class="flex items-center gap-2">`);
  Skeleton($$renderer, { variant: "text", width: "128px", height: "16px" });
  $$renderer.push(`<!----> `);
  Skeleton($$renderer, { variant: "text", width: "96px", height: "12px" });
  $$renderer.push(`<!----></div> <div class="space-y-2">`);
  Skeleton($$renderer, { variant: "text", width: "100%", height: "16px" });
  $$renderer.push(`<!----> `);
  Skeleton($$renderer, { variant: "text", width: "80%", height: "16px" });
  $$renderer.push(`<!----> `);
  Skeleton($$renderer, { variant: "text", width: "60%", height: "16px" });
  $$renderer.push(`<!----></div> `);
  if (Math.random() > 0.5) {
    $$renderer.push("<!--[-->");
    Skeleton($$renderer, {
  ...
  $$renderer.push(`<!--]--> <div class="flex items-center gap-6 pt-2">`);
  Skeleton($$renderer, { variant: "circular", width: "20px", height: "20px" });
  $$renderer.push(`<!----> `);
  Skeleton($$renderer, { variant: "circular", width: "20px", height: "20px" });
  $$renderer.push(`<!----> `);
  Skeleton($$renderer, { variant: "circular", width: "20px", height: "20px" });
...
function StatusCard($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (isReblog) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="flex items-center gap-2 text-sm text-text-secondary"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M4 2a1 1 0 011 1v2.101a7.002 7.002 0 0111.601 2.566 1 1 0 11-1.885.666A5.002 5.002 0 005.999 7H9a1 1 0 010 2H4a1 1 0 01-1-1V3a1 1 0 011-1zm.008 9.057a1 1 0 011.276.61A5.002 5.002 0 0014.001 13H11a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0v-2.101a7.002 7.002 0 01-11.601-2.566 1 1 0 01.61-1.276z"></path></svg> <span>${escape_html(status.account.display_name || status.account.username)} boosted</span></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
    if (showThread && displayStatus.in_reply_to_id) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="flex items-center gap-2 text-sm text-text-secondary"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M2 5a2 2 0 012-2h7a2 2 0 012 2v4a2 2 0 01-2 2H9l-3 3v-3H4a2 2 0 01-2-2V5z"></path></svg> <span>Replying to thread</span></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> <div class="flex items-start gap-3"><a${attr("href", `/@${displayStatus.account.acct}`)} class="flex-shrink-0">`);
    Avatar($$renderer2, {
    ...
    $$renderer2.push(`<!----></a> <div class="flex-1 min-w-0"><div class="flex items-center gap-2 flex-wrap"><a${attr("href", `/@${displayStatus.account.acct}`)} class="font-semibold text-text hover:underline">${escape_html(displayStatus.account.display_name || displayStatus.account.username)}</a> <span class="text-text-secondary">@${escape_html(displayStatus.account.acct)}</span> `);
    if (!isOwnStatus && authStore.currentUser && relationship) ;
    else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> <span class="text-text-secondary">·</span> <time class="text-text-secondary"${attr("datetime", displayStatus.created_at)}>${escape_html(relativeTime)}</time> `);
    if (visibilityIcon) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<span class="text-text-secondary"${attr("title", displayStatus.visibility)}>${escape_html(visibilityIcon)}</span>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--></div> `);
    if (displayStatus.spoiler_text) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<details class="mt-2"><summary class="cursor-pointer text-text-secondary hover:text-text">CW: ${escape_html(displayStatus.spoiler_text)}</summary> <div class="mt-2 prose prose-sm max-w-none text-text">${html(sanitizeMastodonHtml(displayStatus.content))}</div></details>`);
    } else {
      $$renderer2.push("<!--[!-->");
      $$renderer2.push(`<div class="mt-2 prose prose-sm max-w-none text-text">${html(sanitizeMastodonHtml(displayStatus.content))}</div>`);
    }
    $$renderer2.push(`<!--]--> `);
    ...
    if (displayStatus.poll) {
      ...
      for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
        ...
        if (displayStatus.poll.expired || displayStatus.poll.voted) {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<div class="flex-1"><div class="flex justify-between items-center"><span class="text-sm">${escape_html(option.title)}</span> <span class="text-sm text-text-secondary">${escape_html(Math.round(option.votes_count / displayStatus.poll.votes_count * 100))}%</span></div> <div class="mt-1 h-2 bg-surface rounded-full overflow-hidden"><div class="h-full bg-primary transition-all duration-300"${attr_style(`width: ${stringify(option.votes_count / displayStatus.poll.votes_count * 100)}%`)}></div></div></div>`);
        } else {
          $$renderer2.push("<!--[!-->");
          $$renderer2.push(`<button class="flex-1 text-left p-2 rounded-lg border border-border hover:bg-surface-variant transition-colors">${escape_html(option.title)}</button>`);
        }
        $$renderer2.push(`<!--]--></div>`);
      }
      $$renderer2.push(`<!--]--> <div class="text-sm text-text-secondary mt-2">${escape_html(displayStatus.poll.votes_count)} votes `);
    ...
    if (displayStatus.card && !displayStatus.media_attachments.length) {
      ...
      $$renderer2.push(`<!--]--> <div class="flex-1 min-w-0"><div class="font-medium text-sm truncate">${escape_html(displayStatus.card.title)}</div> `);
      if (displayStatus.card.description) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<div class="text-sm text-text-secondary line-clamp-2">${escape_html(displayStatus.card.description)}</div>`);
      } else {
        $$renderer2.push("<!--[!-->");
      }
      $$renderer2.push(`<!--]--> <div class="text-xs text-text-secondary truncate">${escape_html(new URL(displayStatus.card.url).hostname)}</div></div></a>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
    if (lesserStatus.community_notes && lesserStatus.community_notes.length > 0) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="mt-3 p-3 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800"><div class="flex items-center gap-2 mb-2"><svg class="w-5 h-5 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> <span class="font-medium text-blue-900 dark:text-blue-100">Community Note</span></div> <!--[-->`);
      const each_array_1 = ensure_array_like(lesserStatus.community_notes.slice(0, 1));
      for (let $$index_1 = 0, $$length = each_array_1.length; $$index_1 < $$length; $$index_1++) {
        let note = each_array_1[$$index_1];
        $$renderer2.push(`<p class="text-sm text-blue-800 dark:text-blue-200">${escape_html(note.content)}</p> <div class="mt-2 flex items-center gap-4 text-xs text-blue-600 dark:text-blue-400"><span>${escape_html(note.votes_helpful)} found helpful</span> `);
        if (note.votes_unhelpful > 0) {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<span>${escape_html(note.votes_unhelpful)} found unhelpful</span>`);
        } else {
          $$renderer2.push("<!--[!-->");
        }
        $$renderer2.push(`<!--]--></div>`);
    ...
    if (lesserStatus.delivery_cost && authStore.currentUser) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="mt-2 text-xs text-text-secondary">Delivery cost: $${escape_html((lesserStatus.delivery_cost / 1e6).toFixed(6))}</div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> <div class="mt-3 flex items-center gap-1 -ml-2"><button class="flex items-center gap-1 px-2 py-1 rounded-lg text-text-secondary hover:text-primary hover:bg-primary/10 transition-colors" title="Reply"${attr("aria-label", `Reply to post${stringify(displayStatus.replies_count > 0 ? `, ${displayStatus.replies_count} replies` : "")}`)}><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6"></path></svg> `);
    if (displayStatus.replies_count > 0) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<span class="text-sm" aria-hidden="true">${escape_html(displayStatus.replies_count)}</span>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--></button> <div class="relative boost-menu-container"><button${attr_class(`flex items-center gap-1 px-2 py-1 rounded-lg transition-colors ${stringify(displayStatus.reblogged ? "text-green-500" : "text-text-secondary")} hover:text-green-500 hover:bg-green-500/10`)} title="Boost"${attr("aria-label", `${stringify(displayStatus.reblogged ? "Unboost" : "Boost")} post${stringify(displayStatus.reblogs_count > 0 ? `, ${displayStatus.reblogs_count} boosts` : "")}`)}${attr("aria-pressed", displayStatus.reblogged)}${attr("disabled", displayStatus.visibility === "private" || displayStatus.visibility === "direct", true)}><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg> `);
    if (displayStatus.reblogs_count > 0) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<span class="text-sm" aria-hidden="true">${escape_html(displayStatus.reblogs_count)}</span>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--></button> `);
    ...
    $$renderer2.push(`<!--]--></div> <button${attr_class(`flex items-center gap-1 px-2 py-1 rounded-lg transition-colors ${stringify(displayStatus.favourited ? "text-amber-500" : "text-text-secondary")} hover:text-amber-500 hover:bg-amber-500/10`)} title="Favorite"${attr("aria-label", `${stringify(displayStatus.favourited ? "Unfavorite" : "Favorite")} post${stringify(displayStatus.favourites_count > 0 ? `, ${displayStatus.favourites_count} favorites` : "")}`)}${attr("aria-pressed", displayStatus.favourited)}><svg class="w-5 h-5"${attr("fill", displayStatus.favourited ? "currentColor" : "none")} stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path></svg> `);
    if (displayStatus.favourites_count > 0) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<span class="text-sm" aria-hidden="true">${escape_html(displayStatus.favourites_count)}</span>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--></button> <button${attr_class(`flex items-center gap-1 px-2 py-1 rounded-lg transition-colors ${stringify(displayStatus.bookmarked ? "text-primary" : "text-text-secondary")} hover:text-primary hover:bg-primary/10`)} title="Bookmark"${attr("aria-label", `${stringify(displayStatus.bookmarked ? "Remove bookmark" : "Bookmark")} post`)}${attr("aria-pressed", displayStatus.bookmarked)}><svg class="w-5 h-5"${attr("fill", displayStatus.bookmarked ? "currentColor" : "none")} stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path></svg></button> <button class="flex items-center gap-1 px-2 py-1 rounded-lg text-text-secondary hover:text-primary hover:bg-primary/10 transition-colors ml-auto" title="Share" aria-label="Share post"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m9.632 4.658a3 3 0 01-5.266 0m5.266 0a3 3 0 00-5.266 0m5.266 0L18 18m-5.684-2.342a3 3 0 01-5.266 0M6.75 6l1.266 1.342M18 6l-1.266 1.342M12 12h.01"></path></svg></button> `);
    if (isOwnStatus) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="relative"><button class="flex items-center gap-1 px-2 py-1 rounded-lg text-text-secondary hover:text-primary hover:bg-primary/10 transition-colors" title="More options" aria-label="More options for this post"${attr("aria-expanded", showMenu)} aria-haspopup="menu"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"></path></svg></button> `);
      {
        $$renderer2.push("<!--[!-->");
      }
      $$renderer2.push(`<!--]--></div>`);
...
function EmptyState($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="flex-1 flex items-center justify-center p-8"><div class="text-center max-w-md"><div class="mx-auto w-16 h-16 mb-4 rounded-full bg-surface-variant flex items-center justify-center">`);
    if (icon === "inbox") {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<svg class="w-8 h-8 text-text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"></path></svg>`);
    } else {
      $$renderer2.push("<!--[!-->");
      if (icon === "search") {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<svg class="w-8 h-8 text-text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>`);
      } else {
        $$renderer2.push("<!--[!-->");
        if (icon === "users") {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<svg class="w-8 h-8 text-text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>`);
        } else {
          $$renderer2.push("<!--[!-->");
        }
        $$renderer2.push(`<!--]-->`);
    ...
    $$renderer2.push(`<!--]--></div> <h2 class="text-xl font-semibold text-text mb-2">${escape_html(title)}</h2> <p class="text-text-secondary mb-6">${escape_html(message)}</p> `);
    if (action) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<button class="btn btn-primary">${escape_html(action.label)}</button>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--></div></div>`);
      ...
      if (timeline.error) {
        ...
        if (timeline.statuses.length === 0) {
          ...
          if (enablePullToRefresh) {
            $$renderer2.push("<!--[-->");
            $$renderer2.push(`<div${attr_class(`absolute top-0 left-0 right-0 flex justify-center py-4 transition-transform duration-300 ${stringify("-translate-y-full")}`)}><div class="flex items-center gap-2 text-text-secondary">`);
            {
              $$renderer2.push("<!--[!-->");
              {
                $$renderer2.push("<!--[!-->");
                $$renderer2.push(`<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path></svg> <span>Pull to refresh</span>`);
              }
              $$renderer2.push(`<!--]-->`);
            }
            $$renderer2.push(`<!--]--></div></div>`);
          ...
          if (timeline.hasMore) {
            ...
            if (timeline.isLoadingMore) {
              $$renderer2.push("<!--[-->");
              $$renderer2.push(`<div class="w-6 h-6 border-3 border-primary border-t-transparent rounded-full animate-spin mx-auto"></div>`);
            } else {
              $$renderer2.push("<!--[!-->");
              if (!shouldVirtualize) {
                $$renderer2.push("<!--[-->");
                $$renderer2.push(`<button class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-opacity-90 transition-colors">Load more</button>`);
              } else {
                $$renderer2.push("<!--[!-->");
              }
              $$renderer2.push(`<!--]-->`);
            ...
            if (timeline.statuses.length > 0) {
              $$renderer2.push("<!--[-->");
              $$renderer2.push(`<div class="py-4 text-center text-text-secondary"><p>No more posts</p></div>`);
            } else {
              $$renderer2.push("<!--[!-->");
            }
            $$renderer2.push(`<!--]-->`);
...
function Root($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (context.state.error) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="compose-root__error svelte-1mhx2b6" role="alert">${escape_html(context.state.error.message)}</div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
    if (context.state.inReplyTo) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="compose-root__reply-indicator svelte-1mhx2b6">Replying to post</div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
...
function Submit($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (context.state.submitting) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<span class="compose-submit__spinner svelte-gc2xzq"><svg viewBox="0 0 24 24" aria-hidden="true" class="svelte-gc2xzq"><path fill="currentColor" d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm0 18a8 8 0 1 1 8-8 8 8 0 0 1-8 8z"></path><path fill="currentColor" d="M12 4a8 8 0 0 0-8 8h2a6 6 0 0 1 6-6z"></path></svg></span> ${escape_html(loadingText)}`);
    } else {
      $$renderer2.push("<!--[!-->");
...
function CharacterCount($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (showProgress) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<svg class="compose-character-count__progress svelte-1gfrkus" width="32" height="32" viewBox="0 0 32 32"><circle cx="16" cy="16"${attr("r", radius)} fill="none" stroke="var(--compose-progress-bg, #e1e8ed)" stroke-width="2"></circle><circle cx="16" cy="16"${attr("r", radius)} fill="none" stroke="currentColor" stroke-width="2"${attr("stroke-dasharray", circumference)}${attr("stroke-dashoffset", offset)} transform="rotate(-90 16 16)" class="compose-character-count__progress-circle svelte-1gfrkus"></circle></svg>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
    if (isNearLimit || isOverLimit) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<span class="compose-character-count__text svelte-1gfrkus">${escape_html(context.state.characterCount)} / ${escape_html(context.config.characterLimit)}</span>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--></div>`);
...
function VisibilitySelect($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div${attr_class(`compose-visibility-select ${className}`, "svelte-sjbzfi")}><label for="compose-visibility" class="compose-visibility-select__label svelte-sjbzfi">Visibility</label> `);
    $$renderer2.select(
      {
    ...
    $$renderer2.push(` <p class="compose-visibility-select__description svelte-sjbzfi">${escape_html(currentOption.description)}</p></div>`);
  });
}
function AutocompleteMenu($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (loading) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="autocomplete-menu__loading svelte-v7258j"><span class="autocomplete-menu__spinner svelte-v7258j"></span> <span>Loading suggestions...</span></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
      if (suggestions.length === 0) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<div class="autocomplete-menu__empty svelte-v7258j">No suggestions found</div>`);
      } else {
        $$renderer2.push("<!--[!-->");
        $$renderer2.push(`<!--[-->`);
        ...
        for (let index = 0, $$length = each_array.length; index < $$length; index++) {
          ...
          $$renderer2.push(`<!--]--> <div class="autocomplete-menu__content svelte-v7258j"><div class="autocomplete-menu__primary svelte-v7258j">${escape_html(suggestion.text)}</div> `);
          if (suggestion.type === "mention" && suggestion.metadata) {
            ...
            if (suggestion.metadata.followers !== void 0) {
              $$renderer2.push("<!--[-->");
              $$renderer2.push(`<span class="autocomplete-menu__followers svelte-v7258j">${escape_html(suggestion.metadata.followers.toLocaleString())} followers</span>`);
            } else {
              $$renderer2.push("<!--[!-->");
            }
            $$renderer2.push(`<!--]--></div>`);
          ...
          if (suggestion.type === "hashtag") {
            $$renderer2.push("<!--[-->");
            $$renderer2.push(`<div class="autocomplete-menu__secondary svelte-v7258j">#${escape_html(suggestion.value)}</div>`);
          } else {
            $$renderer2.push("<!--[!-->");
          }
          $$renderer2.push(`<!--]--></div> `);
          if (suggestion.type === "emoji") {
            $$renderer2.push("<!--[-->");
            $$renderer2.push(`<span class="autocomplete-menu__emoji svelte-v7258j">${escape_html(suggestion.value)}</span>`);
          } else {
            $$renderer2.push("<!--[!-->");
          }
          $$renderer2.push(`<!--]--></button>`);
...
function EditorWithAutocomplete($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const context = getComposeContext();
    $$renderer2.push(`<div class="editor-with-autocomplete svelte-rf2u5x"><textarea${attr_class(`compose-editor ${className}`, "svelte-rf2u5x")}${attr("rows", rows)}${attr("placeholder", context.config.placeholder)}${attr("disabled", context.state.submitting, true)} aria-label="Compose post content" aria-describedby="compose-character-count">`);
    const $$body = escape_html(context.state.content);
    if ($$body) {
      $$renderer2.push(`${$$body}`);
    }
...
function ThreadComposer($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div${attr_class(`thread-composer ${className}`, "svelte-18qqf34")}><div class="thread-composer__header svelte-18qqf34"><h3 class="thread-composer__title svelte-18qqf34">Compose Thread <span class="thread-composer__count svelte-18qqf34">${escape_html(posts.length)} / ${escape_html(maxPosts)} posts</span></h3></div> `);
    {
      $$renderer2.push("<!--[!-->");
    }
    ...
    for (let index = 0, $$length = each_array.length; index < $$length; index++) {
      ...
      $$renderer2.push(`<div${attr_class("thread-post svelte-18qqf34", void 0, { "thread-post--dragging": draggedPostId === post.id })} draggable="true" role="listitem"${attr("aria-grabbed", draggedPostId === post.id)}><div class="thread-post__header svelte-18qqf34"><div class="thread-post__number svelte-18qqf34">${escape_html(index + 1)}</div> <div class="thread-post__controls svelte-18qqf34"><button type="button" class="thread-post__control svelte-18qqf34"${attr("disabled", index === 0, true)} title="Move up" aria-label="Move post up">↑</button> <button type="button" class="thread-post__control svelte-18qqf34"${attr("disabled", index === posts.length - 1, true)} title="Move down" aria-label="Move post down">↓</button> <button type="button" class="thread-post__control thread-post__control--remove svelte-18qqf34"${attr("disabled", posts.length === 1, true)} title="Remove post" aria-label="Remove post">×</button></div></div> <textarea${attr_class("thread-post__textarea svelte-18qqf34", void 0, { "thread-post__textarea--over-limit": post.overLimit })} placeholder="What's on your mind?"${attr("disabled", submitting, true)} rows="4">`);
      const $$body = escape_html(post.content);
      if ($$body) {
        $$renderer2.push(`${$$body}`);
      }
      $$renderer2.push(`</textarea> <div class="thread-post__footer svelte-18qqf34"><div${attr_class("thread-post__char-count svelte-18qqf34", void 0, {
      ...
      })}>${escape_html(post.characterCount)} / ${escape_html(characterLimit)}</div></div></div>`);
    }
    $$renderer2.push(`<!--]--></div> <div class="thread-composer__actions svelte-18qqf34"><button type="button" class="thread-composer__add-post svelte-18qqf34"${attr("disabled", posts.length >= maxPosts || submitting, true)}><svg viewBox="0 0 24 24" fill="currentColor" class="svelte-18qqf34"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path></svg> Add post to thread</button> <div class="thread-composer__submit-group svelte-18qqf34"><button type="button" class="thread-composer__cancel svelte-18qqf34"${attr("disabled", submitting, true)}>Cancel</button> <button type="button" class="thread-composer__submit svelte-18qqf34"${attr("disabled", !canSubmit, true)}>`);
    {
      $$renderer2.push("<!--[!-->");
...
function MediaUpload($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div${attr_class(`media-upload ${className}`, "svelte-mzn3xv")}><input type="file" accept="image/*,video/*,audio/*" multiple style="display: none;"/> `);
    {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
    if (files.length === 0) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div${attr_class("media-upload__drop-zone svelte-mzn3xv", void 0, { "media-upload__drop-zone--dragging": isDragging })} role="button" tabindex="0"><svg class="media-upload__icon svelte-mzn3xv" viewBox="0 0 24 24" fill="currentColor"><path d="M19 7v2.99s-1.99.01-2 0V7h-3s.01-1.99 0-2h3V2h2v3h3v2h-3zm-3 4V8h-3V5H5c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2v-8h-3zM5 19l3-4 2 3 3-4 4 5H5z"></path></svg> <div class="media-upload__text svelte-mzn3xv">`);
      {
        $$renderer2.push("<!--[!-->");
        $$renderer2.push(`<strong class="svelte-mzn3xv">Click or drag files to upload</strong> <span class="svelte-mzn3xv">Images, videos, or audio</span>`);
      }
      $$renderer2.push(`<!--]--></div></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
      ...
      for (let $$index_1 = 0, $$length = each_array.length; $$index_1 < $$length; $$index_1++) {
        ...
        $$renderer2.push(`<div class="media-upload__item svelte-mzn3xv"><div${attr_class("media-upload__preview svelte-mzn3xv", void 0, {
        ...
        if (previewType === "image" && file.previewUrl) {
          ...
          if (previewType === "video" && file.previewUrl) {
            $$renderer2.push("<!--[-->");
            $$renderer2.push(`<video${attr("src", file.previewUrl)} class="media-upload__preview-video svelte-mzn3xv" muted loop></video>`);
          } else {
            $$renderer2.push("<!--[!-->");
            if (previewType === "audio") {
              $$renderer2.push("<!--[-->");
              $$renderer2.push(`<div class="media-upload__preview-audio svelte-mzn3xv"><svg viewBox="0 0 24 24" fill="currentColor" class="svelte-mzn3xv"><path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z"></path></svg> <span class="svelte-mzn3xv">${escape_html(file.file.name)}</span></div>`);
            } else {
              $$renderer2.push("<!--[!-->");
            }
            $$renderer2.push(`<!--]-->`);
        ...
        if (file.sensitive && file.status !== "uploading" && file.status !== "error") {
          ...
          if (sensitiveVisibility[file.id] !== true) {
            $$renderer2.push("<!--[-->");
            $$renderer2.push(`<div class="media-upload__overlay media-upload__overlay--sensitive svelte-mzn3xv"><span class="media-upload__overlay-label svelte-mzn3xv">Sensitive media</span> `);
            if (file.spoilerText) {
              $$renderer2.push("<!--[-->");
              $$renderer2.push(`<p class="media-upload__overlay-text svelte-mzn3xv">${escape_html(file.spoilerText)}</p>`);
            } else {
              $$renderer2.push("<!--[!-->");
            }
            $$renderer2.push(`<!--]--> <button type="button" class="media-upload__reveal svelte-mzn3xv">Reveal media</button></div>`);
          } else {
            $$renderer2.push("<!--[!-->");
            $$renderer2.push(`<div class="media-upload__badge svelte-mzn3xv">Sensitive</div>`);
          }
          $$renderer2.push(`<!--]-->`);
        } else {
          $$renderer2.push("<!--[!-->");
        ...
        if (file.status === "uploading") {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<div class="media-upload__overlay svelte-mzn3xv"><div class="media-upload__progress svelte-mzn3xv"><svg class="media-upload__progress-ring svelte-mzn3xv" viewBox="0 0 36 36"><path d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="white" stroke-width="3"${attr("stroke-dasharray", `${file.progress}, 100`)}></path></svg> <span class="media-upload__progress-text svelte-mzn3xv">${escape_html(Math.round(file.progress))}%</span></div></div>`);
        } else {
          $$renderer2.push("<!--[!-->");
        }
        $$renderer2.push(`<!--]--> `);
        if (file.status === "error") {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<div class="media-upload__overlay media-upload__overlay--error svelte-mzn3xv"><svg viewBox="0 0 24 24" fill="currentColor" class="svelte-mzn3xv"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"></path></svg> <span class="svelte-mzn3xv">${escape_html(file.error)}</span></div>`);
        } else {
          $$renderer2.push("<!--[!-->");
        }
        $$renderer2.push(`<!--]--> <button type="button" class="media-upload__remove svelte-mzn3xv" aria-label="Remove file">×</button></div> <div class="media-upload__info svelte-mzn3xv"><div class="media-upload__filename svelte-mzn3xv">${escape_html(file.file.name)}</div> <div class="media-upload__filesize svelte-mzn3xv">${escape_html(formatFileSize(file.metadata?.size || 0))}</div></div> <div class="media-upload__meta svelte-mzn3xv"><label class="media-upload__field media-upload__field--toggle svelte-mzn3xv"><input type="checkbox"${attr("checked", file.sensitive, true)}/> <span class="svelte-mzn3xv">Sensitive content</span></label> <label class="media-upload__field svelte-mzn3xv"><span class="media-upload__field-label svelte-mzn3xv">Spoiler text <span class="media-upload__counter svelte-mzn3xv">${escape_html(file.spoilerText.length)}/200</span></span> <input type="text"${attr("value", file.spoilerText)}${attr("maxlength", SPOILER_MAX_LENGTH)} placeholder="Optional warning shown before media" class="svelte-mzn3xv"/></label> <label class="media-upload__field svelte-mzn3xv"><span class="media-upload__field-label svelte-mzn3xv">Description <span class="media-upload__counter svelte-mzn3xv">${escape_html((file.description || "").length)}/1500</span></span> <textarea rows="3"${attr("maxlength", DESCRIPTION_MAX_LENGTH)} placeholder="Describe the media for accessibility" class="svelte-mzn3xv">`);
        const $$body = escape_html(file.description ?? "");
        if ($$body) {
          $$renderer2.push(`${$$body}`);
        }
        $$renderer2.push(`</textarea></label> <label class="media-upload__field svelte-mzn3xv"><span class="media-upload__field-label svelte-mzn3xv">Media type</span> <select class="svelte-mzn3xv"><!--[-->`);
        ...
        $$renderer2.push(`<!--]--></select></label></div></div>`);
      }
      $$renderer2.push(`<!--]--> `);
      if (canAddMore) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<button type="button" class="media-upload__add-more svelte-mzn3xv"><svg viewBox="0 0 24 24" fill="currentColor" class="svelte-mzn3xv"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"></path></svg> <span class="svelte-mzn3xv">Add more</span></button>`);
      } else {
        $$renderer2.push("<!--[!-->");
      }
      $$renderer2.push(`<!--]--></div>`);
...
function ImageEditor($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div${attr_class(`image-editor ${className}`, "svelte-1650mjm")}><div class="image-editor__preview svelte-1650mjm"><div${attr_class("image-editor__image-container svelte-1650mjm", void 0, { "image-editor__image-container--dragging": isDraggingFocal })} role="button" tabindex="0" aria-label="Click to set focal point"><img${attr("src", image.url)}${attr("alt", description || "Image preview")} class="image-editor__image svelte-1650mjm"/> `);
    if (showFocalPoint) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="image-editor__focal-point svelte-1650mjm"${attr_style(`left: ${focalPositionPercent.x}%; top: ${focalPositionPercent.y}%;`)} role="presentation"><div class="image-editor__focal-point-inner svelte-1650mjm"></div></div> <div class="image-editor__focal-instructions svelte-1650mjm">Click or drag to set focal point</div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--></div> `);
    if (showFocalPoint) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="image-editor__focal-controls svelte-1650mjm"><button type="button" class="image-editor__reset-button svelte-1650mjm">Reset to center</button> <span class="image-editor__focal-coords svelte-1650mjm">x: ${escape_html(focalPoint.x.toFixed(2))}, y: ${escape_html(focalPoint.y.toFixed(2))}</span></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--></div> <div class="image-editor__form svelte-1650mjm"><div class="image-editor__field svelte-1650mjm"><label for="alt-text" class="image-editor__label svelte-1650mjm">Alt text (for accessibility) <span class="image-editor__required svelte-1650mjm">Required</span></label> <textarea id="alt-text"${attr_class("image-editor__textarea svelte-1650mjm", void 0, { "image-editor__textarea--error": isDescriptionOverLimit })} placeholder="Describe this image for people using screen readers..." rows="4"${attr("maxlength", maxAltTextLength)}>`);
    const $$body = escape_html(description);
    if ($$body) {
      $$renderer2.push(`${$$body}`);
    }
    $$renderer2.push(`</textarea> <div${attr_class("image-editor__char-count svelte-1650mjm", void 0, { "image-editor__char-count--over": isDescriptionOverLimit })}>${escape_html(remainingChars)} characters remaining</div></div> <div class="image-editor__actions svelte-1650mjm"><button type="button" class="image-editor__cancel svelte-1650mjm">Cancel</button> <button type="button" class="image-editor__save svelte-1650mjm"${attr("disabled", isDescriptionOverLimit || !description.trim(), true)}>Save</button></div></div></div>`);
