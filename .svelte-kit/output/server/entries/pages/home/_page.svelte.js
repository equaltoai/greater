...
_page[FILENAME] = "src/routes/home/+page.svelte";
    ...
    ($$renderer2) => {
      TimelineLayout($$renderer2, {
        ...
        children: prevent_snippet_stringification(($$renderer3) => {
          $$renderer3.push(`<div class="home-page svelte-1j6ictg">`);
          push_element($$renderer3, "div", 8, 2);
          $$renderer3.push(`<div class="compose-section svelte-1j6ictg">`);
          push_element($$renderer3, "div", 9, 4);
          ComposeBoxGC($$renderer3, {});
          $$renderer3.push(`<!----></div>`);
          pop_element();
          $$renderer3.push(` <div class="timeline-section svelte-1j6ictg">`);
